...
| Sebastian Pidek    | Programista, tester      | Implementacja kodu, opracowanie scenariuszy testowych            |
...
W dobie rosnących kosztów życia i dynamicznych zmian ekonomicznych, **zarządzanie budżetem osobistym** staje się kluczową umiejętnością. Mimo dostępności narzędzi finansowych, wielu użytkowników wciąż korzysta z arkuszy kalkulacyjnych lub nie korzysta z niczego.
...
| Interfejsowe     | Mobilny interfejs w technologii Javascript + HTML / Android Studio                               |
...
| Programowanie           | Android Studio / JavaScript  | Implementacja aplikacji               |
...
| 5      | Brak doświadczenia w Javascript  | Wysoki                | Średni     | Szkolenia                                        |
